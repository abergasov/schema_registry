...
func (x *TaskStreamV1) GetAuthor() string {
	if x != nil {
		return x.Author
	}
	return ""
...
func (x *TaskStreamV1) GetAssignCost() int64 {
	if x != nil {
		return x.AssignCost
	}
	return 0
...
func (x *TaskStreamV1) GetDoneCost() int64 {
	if x != nil {
		return x.DoneCost
	}
	return 0
...
func (x *TaskStreamV1) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *TaskStreamV1) GetCreatedAt() string {
	if x != nil {
		return x.CreatedAt
	}
	return ""
...
func (x *TaskStreamV1) GetAssignedTo() string {
	if x != nil {
		return x.AssignedTo
	}
	return ""
...
func (x *TaskStreamV1) GetAssignedAt() string {
	if x != nil {
		return x.AssignedAt
	}
	return ""
...
var file_schema_task_task_stream_1_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x08, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x22, 0xac, 0x02, 0x0a, 0x0c,
	0x54, 0x61, 0x73, 0x6b, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x56, 0x31, 0x12, 0x1a, 0x0a, 0x08,
	...
	0x52, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x12, 0x1e, 0x0a, 0x0a, 0x61, 0x73, 0x73, 0x69,
	0x67, 0x6e, 0x43, 0x6f, 0x73, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x61, 0x73,
	0x73, 0x69, 0x67, 0x6e, 0x43, 0x6f, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x64, 0x6f, 0x6e, 0x65,
	0x43, 0x6f, 0x73, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x64, 0x6f, 0x6e, 0x65,
	...
	0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x61, 0x73,
	0x73, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x54, 0x6f, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a,
	0x61, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x54, 0x6f, 0x12, 0x1e, 0x0a, 0x0a, 0x61, 0x73,
	0x73, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x41, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a,
	0x61, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x41, 0x74, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2f,
...
var file_schema_task_task_stream_1_proto_goTypes = []interface{}{
	(*TaskStreamV1)(nil), // 0: protobuf.TaskStreamV1
}
